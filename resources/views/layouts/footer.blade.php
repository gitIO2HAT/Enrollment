...
<div class="sticky-widget mb-5" style="display:none;">
        <div class="menu d-flex flex-column">
            <a type="button" title="Add College Department" class="mx-2 my-2 py-2   text-white text-center rounded-2" data-bs-toggle="modal" style="width:90px;" data-bs-target="#addCollegeModal">
                <span class="text-white fs-6"> <i class="fas fa-university  " style="color: #90e32b;"></i></span>
            </a>
            <a type="button" title="Add Course"  class="mx-2 my-2 py-2 text-white text-center rounded-2" data-bs-toggle="modal" style="width:90px;" data-bs-target="#addCourseModal">
                <span class="text-white fs-6"> <i class="fas fa-graduation-cap " style="color: #90e32b;"></i></span>
            </a>
            <a type="button" title="Add Major"  class="mx-2 my-2 py-2  text-white text-center rounded-2" data-bs-toggle="modal" style="width:90px;" data-bs-target="#addMajorModal">
                <span class="text-white fs-6"> <i class="fas fa-address-book " style="color: #90e32b;" ></i></span>
            </a>
            
        </div>
        <div class="text-end">
            <button class=" rounded-3 close-button" style="position: fixed; width:40px; height:40px; right: 20px; bottom: 60px;background-color: #90e32b;"><i class="far fa-arrow-alt-circle-down" style="color: #ffffff;"></i></button>
        </div>
    </div>
    <button id="show-widget" class=" rounded-3" style="position: fixed;width:40px; height:40px; right: 20px; bottom: 60px; display: inline; background-color: #90e32b;"><i class="far fa-arrow-alt-circle-up" style="color: #fff;"></i></button>
    @endif
    ...
    <p class="text-muted small mt-1">Beta Build 0.09.10.24</p>
</footer>
